...
public class HtmlTag {
    ...
    /*
     * Checks whether this is the opening tag. If the tag is either the closing tag or self-closing (like <br />, a line break tag that doesn’t need any accompanying text), 
       isOpenTag() will return false.
     */
    ...
    /*
     * Checks whether HtmlTag other this HtmlTag.
     */
    ...
    /*
     * Checks whether a tag is self-closing (e.g. <br />)
     */
    ...
    /*
     *  Compares an HtmlTag to an Object.
     */
    ...
    /*
     * Converts HtmlTag object to a string
     */
    ...
    /*
     *  Creates Queues<HtmlTag> from input string
     */
    ...
    /*
     * Protected ancillary method used by tokenize(String).
     */
